import{j as f}from"./jsx-runtime-BjG_zV1W.js";import{r as v}from"./index-B3TfwC44.js";import{c as y}from"./cx-2dOUpm6k.js";const g=v.forwardRef(function({bsPrefix:e="btn",className:a,unstyled:t,variant:i="primary",size:n,block:r,loading:l,loadingText:o="Loading...",disabled:u,children:s,type:d="button",...m},c){const p=t?a:y(e,`${e}-${i}`,n?`${e}-${n}`:void 0,r?"w-100":void 0,a);return f.jsx("button",{ref:c,type:d,className:p,disabled:u||l,...m,children:l?o:s})});g.__docgenInfo={description:"",methods:[],displayName:"Button",props:{bsPrefix:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:"'btn'",computed:!1}},className:{required:!1,tsType:{name:"string"},description:""},unstyled:{required:!1,tsType:{name:"boolean"},description:""},variant:{required:!1,tsType:{name:"union",raw:`| 'primary'
| 'secondary'
| 'success'
| 'danger'
| 'warning'
